...
// Beta
define('_MI_SF_WARNING_BETA', "Este módulo está sendo entregue como está, sem quaisquer garantias, qualquer mesmo. <br> Este módulo é uma versão BETA, o que significa que ainda está em desenvolvimento constante. Esta versão é simplismente para 
<b>fins de testes exclusivamente</b> e nós <b>veementemente</b> Recomendamos que você não deverá usa-lo em sites remotos (OnLine) ou em um ambiente de produção.");

// RC
define('_MI_SF_WARNING_RC', "Este módulo está sendo entregue na forma como está, sem quaisquer garantias qualquer. Este módulo é uma atualização candidata (RC) e não deve ser utilizado em um site de produção (OnLine / Remoto). 
O módulo ainda está em desenvolvimento ativo e seu uso está sob sua inteira e própria responsabilidade, isto significa que o autor não se responsabiliza por qualquer problema que possa existir.");

// Final
define('_MI_SF_WARNING_FINAL', "Este módulo está sendo fornecido na forma como está, sem quaisquer garantias, qualquer mesmo. Embora este módulo não é uma versão beta, ela ainda está em desenvolvimento ativo neste momento. 
Esta versão pode ser usada em um site (Remoto / OnLine) ou trabalhar em um ambiente de produção, mas a sua utilização está sob sua total responsabilidade, o que significa que o autor não se responsabiliza por qualquer problema ou erro que venha a existir.");
