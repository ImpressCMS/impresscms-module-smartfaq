...
if (!defined("XOOPS_ROOT_PATH")) { 
 	die("O caminho para o raiz deste portal não está definido");
}
...
define("_SDU_NEEDUPDATE", "Seu Banco de Dados não está atualizado. Por favor atualize sua tabela do Banco de Dados!<br><b>Nota: O SmartFactory recomenda o backup de todas as tabelas de SmartSection antes de funcionar este script de atualização.</b><br>");
define("_SDU_NOUPDATE", "Seu Banco de Dados está atualizado. Não é necessario rodar a atualização.");
