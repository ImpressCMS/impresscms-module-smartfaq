...
define("_AM_SF_ACTION", "برو");
define("_AM_SF_ADMINCOLMNGMT", "مدیریت شاخه ها");
define("_AM_SF_ADMIN_CATS", "شاخه هایی را که هر گروه میتواند نظارت کند انتخاب کنید");
define("_AM_SF_ALL", "همه");
define("_AM_SF_ALL_EXP", "<b>همه حالت ها</b> : همه پرسش و پاسخ ها با هر حالتی");
define("_AM_SF_ALLOWCOMMENTS", "پرسش و پاسخ نظر داشته باشد؟");
...
define("_AM_SF_ANSWER_OFFICIAL", "پاسخ اولیه");
define("_AM_SF_ANSWER_REJECTED", "پاسخی که به پرسش داده شده بود حذ�? گردید");
